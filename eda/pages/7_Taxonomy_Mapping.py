...
arch_data = {
    ...
    "Dataset": [
        ...
        "ContractNLI",
        "MAUD",
        "All 4 datasets (curated, not split)",
    ],
    "Role": [
        ...
        "Expert-annotated M&A deal-point QA for merger agreement review",
        "Reward model training / RLHF — boundary cases and ambiguous examples",
    ],
    "Format": [
        ...
        "deal-point QA: {passage, question, expected_answer, category}",
        "undivided pool — no train/val/test split applied",
    ],
}
